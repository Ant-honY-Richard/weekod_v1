...
export default function Orb({
  ...
  const [oglError, setOglError] = useState(false);
  ...
  useEffect(() => {
    ...
    const initOrb = async () => {
      try {
        ...
        // Use dynamic import with proper error handling for Turbopack
        const OGL = await import('ogl').catch((error) => {
          console.warn('Failed to import OGL, falling back to CSS orb:', error);
          setOglError(true);
          return null;
        });
        ...
        console.error('Failed to initialize Orb:', error);
        setOglError(true);
      }
    };
