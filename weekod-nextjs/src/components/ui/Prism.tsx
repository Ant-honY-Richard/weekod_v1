...
const Prism: React.FC<PrismProps> = ({
  ...
  useEffect(() => {
    ...
    const currentBaseWidth = isMobile && mobileBaseWidth ? mobileBaseWidth : baseWidth;
    const currentScale = isMobile && mobileScale ? mobileScale : scale;

    const H = Math.max(0.001, currentHeight);
    const BW = Math.max(0.001, currentBaseWidth);
